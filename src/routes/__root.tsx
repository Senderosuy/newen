...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "NEWEN ofrece traslados ejecutivos, turismo, eventos sociales y chárter en minibuses Mercedes-Benz Sprinter y Renault Master en Uruguay." },
      { name: "author", content: "NEWEN" },
      { property: "og:title", content: "NEWEN — Transporte de Pasajeros en Uruguay" },
      { property: "og:description", content: "Traslados ejecutivos, turismo y eventos premium con Mercedes-Benz Sprinter y Renault Master." },
